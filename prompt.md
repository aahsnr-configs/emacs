...
- [ ] Use the context in claude.ai aahsnr041@proton.me to verify that the configurations for lsp-mode, dap-mode, flycheck, apheleia and treesit (apart from the python specific configurations) is sufficient and accurate as well making sure that this make emacs a proper IDE
