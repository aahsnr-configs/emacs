...
(use-package yasnippet
  ...
  ;; --- FIX: Defer Snippet Inheritance Configuration ---
  ;; This prevents a circular dependency during package compilation by waiting
  ;; for both Org and AUCTeX to be fully loaded before modifying yasnippet.
  (with-eval-after-load 'org
