...
(use-package catppuccin-theme
  ...
  (custom-set-faces
   ...
   ;; --- Org Mode Header Colors (Mocha Palette) ---
   '(org-level-1 ((t (:inherit outline-1 :foreground "#f5e0dc"))))
   '(org-level-2 ((t (:inherit outline-2 :foreground "#cba6f7"))))
   '(org-level-3 ((t (:inherit outline-3 :foreground "#89b4fa"))))
   '(org-level-4 ((t (:inherit outline-4 :foreground "#7f849c"))))
   '(org-level-5 ((t (:inherit outline-5 :foreground "#f38ba8"))))
   '(org-level-6 ((t (:inherit outline-6 :foreground "#fab387"))))
   '(org-level-7 ((t (:inherit outline-7 :foreground "#eba0ac"))))
   '(org-level-8 ((t (:inherit outline-8 :foreground "#f5e0dc"))))
   ))
#+end_src
...
(use-package org-modern
  ...
  (setq org-modern-hide-stars "· "
	...
	org-modern-todo-faces ; <--- ADD THIS LINE
	'(("TODO"      . (:foreground "#f38ba8" :weight bold))
          ("NEXT"      . (:foreground "#fab387" :weight bold))
          ("PROG"      . (:foreground "#89b4fa" :weight bold))
          ("WAIT"      . (:foreground "#f9e2af" :weight bold))
