...
(use-package org
  ...
  (org-todo-keywords
   '((sequence "ðŸ“¥ TODO(t)" "âš¡ NEXT(n)" "âš™ï¸ PROG(p)" "â³ WAIT(w@/!)" "|" "âœ… DONE(d!)" "âŒ CANCEL(c@)")
  ...
  (org-todo-keyword-faces
   '(("ðŸ“¥ TODO"      . (:foreground "#f7768e" :weight bold))
     ...
     ("âŒ CANCEL"    . (:foreground "#565f89" :weight bold))
...
(use-package org-modern
  ...
  (setq org-modern-hide-stars "Â· "
        ...
        '(("ðŸ“¥ TODO"      . (:foreground "#f7768e" :weight bold))
          ...
          ("âš™ï¸ PROG"      . (:foreground "#7aa2f7" :weight bold))
          ("â³ WAIT"      . (:foreground "#e0af68" :weight bold))
          ("âœ… DONE"      . (:background "#2f3c22" :foreground "#9ece6a" :weight bold))
          ("âŒ CANCEL"    . (:strike-through t :foreground "#565f89"))
          ("ðŸ“ PLAN"      . (:foreground "#73daca" :weight bold))
          ("ðŸš€ ACTIVE"    . (:foreground "#bb9af7" :weight bold))
          ("â¸ï¸ PAUSED"    . (:foreground "#c0caf5" :weight bold))
          ("ðŸ† ACHIEVED"  . (:background "#364a5c" :foreground "#9ece6a" :weight bold :box t))
          ("ðŸ—‘ï¸ DROPPED"   . (:strike-through t :foreground "#565f89")))
...
(use-package org-agenda
  ...
  (setq org-agenda-custom-commands
        '(("d" "ðŸ“… Dashboard"
          ...
          ("w" "ðŸ’¼ Work Context"
           ((tags-todo "@work/âš¡ NEXT" ((org-agenda-overriding-header "ðŸ’¼ Work Next")))
            (tags-todo "@work/ðŸ“¥ TODO" ((org-agenda-overriding-header "ðŸ’¼ Work Tasks")))
            (tags-todo "@work+project/ðŸš€ ACTIVE" ((org-agenda-overriding-header "ðŸ’¼ Work Projects")))))

          ("h" "ðŸ  Home Context"
           ((tags-todo "@home/âš¡ NEXT" ((org-agenda-overriding-header "ðŸ  Home Next")))
            (tags-todo "@home/ðŸ“¥ TODO" ((org-agenda-overriding-header "ðŸ  Home Tasks")))))
          ...
          ("r" "ðŸ” Review"
           ((agenda "" ((org-agenda-span 'day) (org-agenda-overriding-header "ðŸ“… Today")))
            (todo "âœ… DONE" ((org-agenda-overriding-header "âœ… Completed Today")
...
** ðŸ“¥ TODO Capture: The Gateway to Org
...
(use-package org-capture
  ...
  (org-capture-templates
   '(("t" "ðŸ“¥ Task" entry (file+headline "~/org/inbox.org" "Tasks")
     ...
     ("m" "ðŸ¤ Meeting" entry (file+headline "~/org/inbox.org" "Meetings")
      "* Meeting: %? :meeting:\n  :PROPERTIES:\n  :CREATED: %U\n  :ATTENDEES: \n  :END:\n** Agenda\n** Notes\n** Action Items\n")
...
(use-package org-habit
  ...
  (org-habit-graph-mature-star "âœ…")
  (org-habit-graph-fresh-star "ðŸ‘Œ")
  (org-habit-graph-ready-star "ðŸ‘")
  (org-habit-graph-early-star "ðŸŒ±")
  (org-habit-graph-late-star "ðŸ‘Ž")
  (org-habit-graph-future-star "â€¦"))
#+end_src
...
#+begin_src emacs-lisp
;; Disable Corfu in Jupyter org-src blocks to prevent completion conflicts
...
** Core Setup
Replace the following two sections with this simpler core section
#+begin_src emacs-lisp
(use-package jupyter)
...
(defun ar/latex-prettify-symbols-setup ()
  ...
  (mapc (lambda (rule) (push rule prettify-symbols-compose-rules))
        '(("\\sum" . ?âˆ‘) ("\\int" . ?âˆ«) ("\\in" . ?âˆˆ) ("\\forall" . ?âˆ€)
          ("\\exists" . ?âˆƒ) ("\\lambda" . ?Î») ("\\alpha" . ?Î±) ("\\beta" . ?Î²)
          ("\\gamma" . ?Î³) ("\\delta" . ?Î´) ("\\epsilon" . ?Îµ) ("\\pi" . ?Ï€)
