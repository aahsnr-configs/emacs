...
(with-eval-after-load 'eglot
  ...
  ;; Configure pyright to cede type checking to mypy. This prevents
  ;; duplicate and potentially conflicting diagnostics. Pyright will still
  ;; provide other valuable, fast analysis.
  (setf (alist-get '(python-ts-mode) eglot-workspace-configuration)
        '(:python
          (:analysis
