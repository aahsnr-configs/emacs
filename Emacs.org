...
(use-package yasnippet
  ...
  ;; Define the desired path, set the variable for yasnippet, and create
  ;; the directory if it doesn't exist. This avoids timing issues.
  (let ((cache-dir (expand-file-name "yasnippet-cache" no-littering-var-directory)))
    (setq yas-snippet-cache-dir cache-dir)
