...
- [x] Small Configs
- [ ] Functions - _Top Level Header_ & _General keybindings_
...
- [ ] Fix dired/dirvish issues later
- [ ] diredfl delay for dirvish
...
[NOTE]: **Query for the folowing tasks after applying the above fixes**
