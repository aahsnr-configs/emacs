...
(use-package perspective
  ...
  ;; Hook this function into project.el to run after switching projects.
  (add-hook 'project-switch-hook #'ar/perspective-switch-or-create)
...
(ar/global-leader
 ...
 "p d" '(project-find-dir :wk "find directory in project")
 "p b" '(consult-project-buffer :wk "find buffer in project")
 "p g" '(consult-ripgrep :wk "grep in project")
 "p s" '(:ignore t :wk "save/kill")
 "p s s" '(project-save-buffers :wk "save project buffers")
 "p s k" '(project-kill-buffers :wk "kill project buffers")
 "p c" '(project-compile :wk "compile project")
 "p R" '(project-query-replace-in-files :wk "replace in project"))
