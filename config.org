...
;; === CRITICAL FIXES FOR BOUNDARY SIGNALS ===

;; 1. Silence the Bell (Prevents Modeline Splashing)
;; Ensure you have REMOVED (doom-themes-visual-bell-config) from your theme config
(setq visible-bell nil)
(setq ring-bell-function #'ignore)

;; 2. Suppress "End/Beginning of buffer" Messages
;; This intercepts the signal before it prints to the echo area, allowing
;; ElDoc's "Bottom Level" / "Top Level" to remain visible.
