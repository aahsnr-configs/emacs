...
(use-package treemacs
  ;; Defer loading until our custom toggle command is called.
  :commands (ar/toggle-treemacs)
  ;; Bind the winum key for selecting the treemacs window.
  :bind (:map winum-keymap
              ("M-0" . treemacs-select-window))
  :config
  ;; --- Core Functionality ---
  (defun ar/toggle-treemacs ()
    "A reliable command to open or close Treemacs.
If the Treemacs buffer is visible, close it. Otherwise, open
Treemacs and focus on the current file."
    (interactive)
...
(use-package general
  ...
  (ar/global-leader
    ...
    "t t" '(ar/open-treemacs-project :wk "Treemacs")
