...
** Helper Functions (Project Awareness)
#+begin_src emacs-lisp
...
** Global Keybindings
TODO: integrate into General Keybindigs later
#+begin_src emacs-lisp
...
;;     "l k" '((lambda () (interactive) (TeX-command "LuaLaTeXmk" 'TeX-master-file)) :wk "LuaLaTeXmk")
;;     "l w" '((lambda () (interactive) (TeX-command "LaTeXmk-Watch" 'TeX-master-file)) :wk "Watch")
...
;;     "l b s" '(ar/setup-project-bibliography :wk "Setup Project Bib")
