...
(use-package org
  ...
  :hook ((org-mode . (lambda ()
                       ...
                       ;; CRITICAL: Bind RET to (org-return t).
                       ;; This forces Org to handle the newline and immediately calculate 
                       ;; the correct indentation for the source language.
                       (evil-define-key 'insert org-mode-map (kbd "RET") 
                         (lambda () (interactive) (org-return t)))
                       
                       (evil-define-key 'normal org-mode-map (kbd "TAB") #'org-cycle)
                       (evil-define-key 'normal org-mode-map (kbd "[b") #'ar/org-goto-src-block-head)
                       (evil-define-key 'normal org-mode-map (kbd "]b") #'ar/org-goto-src-block-head)))
  ...
  :config
  ;; === Navigation Helpers ===
  (defun ar/org-goto-src-block-head ()
    "Go to the first line of the current source block content."
    (interactive)
...
(python . t) (ruby . t) 
  ...
  ;; CRITICAL INDENTATION SETTINGS
  ;; Must be nil for internal indentation to work correctly without jumping
  (org-src-preserve-indentation nil) 
  ;; Keep content flush with #+begin_src
