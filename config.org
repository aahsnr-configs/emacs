...
(use-package git-gutter
  :defer t
  :commands (git-gutter:next-hunk git-gutter:previous-hunk git-gutter:stage-hunk git-gutter:revert-hunk git-gutter:popup-hunk)
  ...
  ;; Do not ask when reverting a hunk
  (setq git-gutter:ask-p nil)
  :config
  ;; Enable globally to catch modes not covered by hooks
  (global-git-gutter-mode +1))

(use-package git-gutter-fringe
  :after git-gutter
  :config
  ;; These create clean, modern vertical bars in the fringe
...
(git-timemachine-show-minibuffer-details t)
  ...
  (git-timemachine-minibuffer-detail-face ((t (:foreground "#c0caf5"))))
...
(add-hook 'git-timemachine-mode-hook #'ar/git-timemachi
  ne-setup)
...
(pretty-hydra-define version-control-hydra
  ...
  ("Magit Core"
   ...
   (("b" magit-branch "branches" :exit t)
    ...
    ("l" magit-log-buffer-file "log file" :exit t)
   ...
   (("n" git-gutter:next-hunk "next hunk")
    ("N" git-gutter:previous-hunk "prev hunk")
    ("h" git-gutter:popup-hunk "preview")
    ("a" git-gutter:stage-hunk "stage")
    ("v" git-gutter:revert-hunk "revert"))
   
   "Timemachine"
   (("t" git-timemachine-toggle "toggle" :toggle git-timemachine-mode)
    ("j" git-timemachine-show-next-revision "next")
    ("k" git-timemachine-show-previous-revision "previous")
    ("w" git-timemachine-kill-abbreviated-revision "copy hash")
    ("W" git-timemachine-kill-revision "copy full hash")
    ("y" git-timemachine-show-commit "show" :exit t))
